...
public class LanguageManager extends ResourceBundle {

	private final HashMap<String, Object> currentLangMap = new HashMap<>();
	
	public LanguageManager() {
		this.setLanguages(Language.en_us);
	}
	
	public void setLanguages(@NotNull Language lang) {
	...
	public String getTranslateFromLanguage(String key, @NotNull Language language) {
